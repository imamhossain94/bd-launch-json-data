...
<div style="display: flex; gap: 8px; overflow-x: auto; width: 100%; padding: 10px 0;">
  ...
  <div style="display: flex; flex-direction: column; gap: 8px;">
    <img src="launch-image\MV Zam Zam 7.jpg" width="200" height="150" style="object-fit: cover; border-radius: 4px;" alt="MV Zam Zam 7" />
    <img src="launch-image\MV Mayur 10.jpg" width="200" height="150" style="object-fit: cover; border-radius: 4px;" alt="MV Mayur 10" />
  </div>
  ...
  <div style="display: flex; flex-direction: column; gap: 8px;">
    <img src="launch-image\MV Sundarban 16.jpg" width="200" height="150" style="object-fit: cover; border-radius: 4px;" alt="MV Sundarban 16" />
